...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const projectsData = [
    ...
    {
      id: 'proj-7',
      title: 'Baby YUH Visual Design',
      category: 'flyer',
      categoryLabel: 'Flyer Design',
      image: 'assets/images/Baby YUH.jpeg',
      isVideo: false,
      video: '',
      year: '2026',
      tags: ['Visual Design', 'Flyer'],
      description: 'Creative visual design and promotional flyer layout.'
    },
    {
      id: 'proj-8',
      title: 'Burger Motion Video',
      category: 'motion',
      categoryLabel: 'Motion Graphics',
      image: '',
      isVideo: true,
      video: 'assets/images/Burger.mp4',
      year: '2026',
      tags: ['Motion Design', 'Food Ad'],
      description: 'Engaging motion graphic video showcasing food products with dynamic transitions.'
    },
    {
      id: 'proj-9',
      title: 'Kaduna Visual Layout',
      category: 'flyer',
      categoryLabel: 'Flyer Design',
      ...
      video: '',
      year: '2026',
      tags: ['Visual Flyer', 'Layout'],
      description: 'Stunning visual layout highlighting bold typography and spatial design.'
    },
    {
      id: 'proj-10',
      title: 'Lime Animation',
      category: 'motion',
      categoryLabel: 'Motion Graphics',
      image: '',
      isVideo: true,
      video: 'assets/images/Lime Animation.mp4',
      year: '2026',
      tags: ['3D Motion', 'Animation'],
      description: 'Smooth kinetic animation featuring fresh visual concepts.'
    },
    {
      id: 'proj-11',
      title: 'Magic Portal Flyer',
      category: 'flyer',
      categoryLabel: 'Flyer Design',
      image: 'assets/images/Magic portal.jpeg',
      isVideo: false,
      video: '',
      year: '2026',
      tags: ['Creative Visual', 'Flyer'],
      description: 'Creative promotional flyer design with magical themes and vibrant colors.'
    },
    {
      id: 'proj-12',
      title: 'Brand Rebrand Motion',
      category: 'motion',
      categoryLabel: 'Motion Graphics',
      image: '',
      isVideo: true,
      video: 'assets/images/Rebrand.mp4',
      year: '2026',
      tags: ['Rebranding', 'Motion Reel'],
      description: 'High-impact motion graphic reel designed for a brand rebranding launch.'
    },
    {
      id: 'proj-13',
      title: 'Walking Animation 2',
      category: 'motion',
      categoryLabel: 'Motion Graphics',
      image: '',
      isVideo: true,
      video: 'assets/images/Walking animation 2.mp4',
      year: '2026',
      tags: ['Character Animation', 'Motion'],
      description: 'Character walking animation utilizing fluid 3D motion techniques.'
    },
    {
      id: 'proj-14',
      title: 'Walking Woman Animation',
      category: 'motion',
      categoryLabel: 'Motion Graphics',
      image: '',
      isVideo: true,
      video: 'assets/images/Walking woman animation.mp4',
      year: '2026',
      tags: ['Character Animation', 'Motion'],
      description: 'Smooth and realistic walking woman animation sequence.'
    }
  ];
